    ...
    >
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="inline-block px-4 py-1.5 rounded-full text-xs font-bold tracking-widest uppercase text-ipnu-600 border border-ipnu-200 bg-ipnu-50 mb-4 cursor-default">
            Tentang Program
          </span>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            Mengapa{" "}
            <span className="gradient-text-green" style={{ color: "#059669" }}>
              OSB IPNU IPPNU?
            </span>
          </h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {FEATURES.map((f) => {
            ...
            return (
              <div
                key={f.title}
                className="glass-card rounded-2xl p-6 text-center group bg-white relative overflow-hidden transition-all duration-300 hover:-translate-y-2"
              >
                ...
                <div
                  ...
                  style={{
                    backgroundColor: f.iconColor.includes("emerald")
                      ? "#ecfdf5"
                      : f.iconColor.includes("amber")
                        ? "#fffbeb"
                        : f.iconColor.includes("blue")
                          ? "#eff6ff"
                          : "#f5f3ff",
                  }}
                >
