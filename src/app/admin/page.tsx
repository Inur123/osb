...
import { UsersIcon, CalendarIcon, TargetIcon, UserCheckIcon } from "lucide-react"
  ...
  return (
    <div className="flex flex-col gap-10">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground text-sm sm:text-lg">Pusat kontrol dan monitoring pendaftaran OSB.</p>
      </div>
      ...
      <div className="grid auto-rows-min gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="bg-muted/50 border-none shadow-none">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Seluruh periode</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-muted/50 border-none shadow-none">
          ...
          <CardContent>
            <div className="text-2xl font-bold truncate">{activePeriode?.nama || "Tutup"}</div>
            <Badge variant={activePeriode ? "default" : "destructive"} className="mt-1 text-[10px]">
        ...
        <Card className="bg-muted/50 border-none shadow-none">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Pendaftar Laki-laki</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-muted/50 border-none shadow-none">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Pendaftar Perempuan</p>
          </CardContent>
        </Card>
      </div>
