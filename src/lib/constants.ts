...
export const OLAHRAGA_ITEMS = [
  {
    name: "Futsal",
    desc: "Permainan tim yang mengasah kerjasama dan strategi.",
  },
  {
    name: "Bulutangkis",
    desc: "Olahraga raket yang melatih kelincahan dan refleks.",
  },
  { name: "Bola Voli", desc: "Permainan tim yang membangun kekompakan." },
  {
    name: "Dan Lainnya",
    desc: "Berbagai cabang olahraga lain yang bisa kamu eksplorasi.",
  },
] as const;
